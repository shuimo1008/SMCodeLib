using System;
using ZCSharpLib.Zips.Additional;

namespace ZCSharpLib.Zips.Checksum
{
	/// <summary>
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="ZCSharpLib.SharpZip.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="ZCSharpLib.SharpZip.Zip.Compression.Streams.DeflaterOutputStream"/>
	public sealed class Adler32 : IChecksum
	{
		...
		public void Update(byte[] buffer)
		{
			...
			Update(new ZArraySegment<byte>(buffer, 0, buffer.Length));
		}
        ...
        /// </param>
        public void Update(ZArraySegment<byte> segment)
        {
