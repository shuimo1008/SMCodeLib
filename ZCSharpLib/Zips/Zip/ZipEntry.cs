...
namespace ZCSharpLib.Zips.Zip
{
	...
	public class ZipEntry
	{
		...
		/// </returns>
		/// <see cref="ZCSharpLib.SharpZip.Zip.CompressionMethod.Deflated"/>
		/// <see cref="ZCSharpLib.SharpZip.Zip.CompressionMethod.Stored"/>
        ...
        /// </summary>
        /// <returns>An <see cref="System.Object"/> that is a copy of the current instance.</returns>
        public object Clone()
		{
